# App communication | Home Assistant Developer Docs

> Source: https://developers.home-assistant.io/docs/add-ons/communication#network
> Cached: 2026-06-13T20:04:31.462Z
...
On this page# App communication
...
There is also a proxy for the [Home Assistant Websocket API](/docs/api/websocket) that works like the API proxy above and requires `SUPERVISOR_TOKEN` as the password. Use this URL: `ws://supervisor/core/websocket`.
...
We have an internal services API to make services public to other apps without the user needing to add any configuration. An app can get the full configuration for a service to use and to connect to it. The app needs to mark the usage of a service in the app [configuration](/docs/apps/configuration) in order to be able to access a service. All supported services, including its available options, are documented in the [API documentation](/docs/api/supervisor/endpoints#service).
...
[Edit this page](https://github.com/home-assistant/developers.home-assistant/edit/master/docs/apps/communication.md)Last updated on **Jan 28, 2026**